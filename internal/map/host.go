...
func addHostElement(zbxMap *zabbixgosdk.MapCreateParameters, id string, host string) *zabbixgosdk.MapElement {
...
func addHosts(zbxMap *zabbixgosdk.MapCreateParameters, id string, host string) *zabbixgosdk.MapCreateParameters {
	if exist := elementExist(id, zbxMap.Elements); !exist {
		element := addHostElement(zbxMap, id, host)
